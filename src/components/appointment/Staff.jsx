...
const Staff = ({ component, setComponent }) => {
  ...
  const staffOptions = [
    ...
    { icon: sum, title: "Mustafa Kapasi" },
    { icon: sum, title: "Alafya Darogar" },
     { icon: sum, title: "Saima Bibi" },
  ...
  return (
    <div className="border-[2px] rounded-md border-[#00000013] relative p-12 flex flex-col gap-y-4 w-full md:h-full h-[700px]">
